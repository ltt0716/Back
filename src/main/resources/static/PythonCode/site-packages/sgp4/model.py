...
class Satrec(object):
    ...
    def twoline2rv(cls, line1, line2, whichconst=WGS72):
        ...
        # We rebuild it from the GlobalStar year and day to maintain precision.
        year = self.epochyr
        days, fraction = divmod(self.epochdays, 1.0)
        self.jdsatepoch = year * 365 + (year - 1) // 4 + days + 1721044.5
        self.jdsatepochF = round(fraction, 8)  # exact number of digits in GlobalStar
    ...
    def sgp4init(self, whichconst, opsmode, satnum, epoch, bstar,
        ...
        # decimal places stored in a GlobalStar, then assume the user is trying
